...
coremark kmod-ipt-raw kmod-nf-nathelper kmod-nf-nathelper-extra \
...
openssh-server openssl-util openssh-sftp-server openssh-sftp-client libustream-openssl \
luci-base luci-i18n-base-zh-cn luci-compat luci-theme-argon luci-app-argon-config \
...
luci-app-syncdial luci-i18n-syncdial-zh-cn \
...
# For router targets
DEFAULT_PACKAGES.router:=dnsmasq-full ppp ppp-mod-pppoe firewall
